...
public class SQLiteLocationDAO implements LocationDAO {
    ...
    private Collection<BackgroundLocation> getLocations(String whereClause, String[] whereArgs) {
        ...
        String[] columns = {
                ...
                LocationEntry.COLUMN_NAME_SIGNAL_STRENGTH,
                LocationEntry.COLUMN_NAME_DEVICE_MANUFACTURER,
                LocationEntry.COLUMN_NAME_DEVICE_MODEL,
                LocationEntry.COLUMN_NAME_DEVICE_ID,
        };
    ...
    public Long persistLocationWithLimit(BackgroundLocation location, Integer maxRows) {
        ...
        sql = new StringBuilder("UPDATE ")
                ...
                .append(LocationEntry.COLUMN_NAME_SIGNAL_STRENGTH).append("= ?,")
                .append(LocationEntry.COLUMN_NAME_DEVICE_MANUFACTURER).append("= ?,")
                .append(LocationEntry.COLUMN_NAME_DEVICE_MODEL).append("= ?,")
                .append(LocationEntry.COLUMN_NAME_DEVICE_ID).append("= ?,")
        ...
        db.execSQL(sql, new Object[]{
                ...
                location.getSignalStrength(),
                location.getDeviceManufacturer(),
                location.getDeviceModel(),
    ...
    private BackgroundLocation hydrate(Cursor c) {
        ...
        l.setSignalStrength(c.getInt(c.getColumnIndex(LocationEntry.COLUMN_NAME_SIGNAL_STRENGTH)));
        l.setDeviceManufacturer(c.getString(c.getColumnIndex(LocationEntry.COLUMN_NAME_DEVICE_MANUFACTURER)));
        l.setDeviceModel(c.getString(c.getColumnIndex(LocationEntry.COLUMN_NAME_DEVICE_MODEL)));
        l.setDeviceId(c.getString(c.getColumnIndex(LocationEntry.COLUMN_NAME_DEVICE_ID)));
    ...
    private ContentValues getContentValues(BackgroundLocation l) {
        ...
        values.put(LocationEntry.COLUMN_NAME_SIGNAL_STRENGTH, l.getSignalStrength());
        values.put(LocationEntry.COLUMN_NAME_DEVICE_MANUFACTURER, l.getDeviceManufacturer());
        values.put(LocationEntry.COLUMN_NAME_DEVICE_MODEL, l.getDeviceModel());
        values.put(LocationEntry.COLUMN_NAME_DEVICE_ID, l.getDeviceId());
